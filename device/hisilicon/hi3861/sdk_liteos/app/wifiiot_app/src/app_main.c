...
hi_void app_main(hi_void)
{
    ...
    ///////////////////////////////
    hi_sys_led_bulb cfg12;
    ret = hi_nv_read(HI_NV_SYS_SAVE_STATE, &cfg12, sizeof(cfg12), 0);
    if (ret != HI_ERR_SUCCESS) {
        printf("nv read fail\r\n");
        return;
    }
    //hilink_set_g_device_info().switch_on = cfg12.led_state; 
    //hilink_set_g_device_info(cfg12.led_state, 0, 0);
    g_device_info.switch_on = cfg12.led_state;
